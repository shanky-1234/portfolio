...
function Footer() {
  return (
   <footer className=" bg-main overflow-hidden pb-8">
  <div className="px-6 section-wrapper md:px-10 py-10 md:py-12">
      ...
      <div className="space-y-8 md:space-y-4">
        ...
        <p className="font-secondary  text-white">
          ...
          <div className='flex gap-8 md:gap-8 flex-row w-full'>
            <div className='w-8 h-8 md:w-10 md:h-10 hover:rotate-5 hover:scale-110 transition-all duraition-300'>
